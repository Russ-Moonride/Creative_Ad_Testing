...
### Information to be switched when creating a new app ###
Account = "Uqora"
bucket_name = "uqora_creativetesting_images"
main_table_id = 'uqora-401619.uqora_segments.uqora_ad_level'
creativetesting_table_id = 'uqora-401619.uqora_streamlit.creativetestingstorage'
correct_hashed_password = "CFUqoraAdTest8371$"
